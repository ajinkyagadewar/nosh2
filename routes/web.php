...
Route::any('validate', ['as' => 'validate', 'uses' => 'LoginController@validate_user']);
...
Route::any('encounter_edit_image/{id?}', ['as' => 'encounter_edit_image', 'uses' => 'ChartController@encounter_edit_image']);
